...
def parse_opt():
    ...
    finetune=False
    if data_name=='f30k':
        data_path = '/data/gongziyu'
        feature_path = '/data/gongziyu/VLP_features/flickr30k/region_feat_gvd_wo_bgd/trainval/'
    else:
        data_path = "/data/gongziyu"
        feature_path = "/data/gongziyu/VLP_features/COCO/region_feat_gvd_wo_bgd/feat_cls_1000/coco_detection_vg_100dets_gvd_checkpoint_trainval"
    epoch=20
    lr=0.0005 
    lr_update=10
    bz= 64 
    ...
    #parser.add_argument('--balance', default=0.8)
