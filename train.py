...
from evaluation import i2t, t2i, AverageMeter, LogCollector, encode_data, shard_xattn_i2t,shard_xattn_t2i,shard_xattn_all,shard_xattn_flash
import logging
...
def train(opt, train_loader, model,epoch, val_loader):
    ...
    for i, train_data in enumerate(train_loader):
        ...
        #if model.Eiters % 1000 == 0: #opt.val_step
...
def validate(opt, val_loader, model):
    ...
    elif opt.cross_attn == "flash":
        #sims,_,_ = shard_xattn_all(img_embs, cap_embs, region_embs, word_embs, cap_lens, opt, shard_size=128)
        sims,_,_= shard_xattn_flash(img_embs, cap_embs, region_embs, word_embs, cap_lens, opt, shard_size=128)
...
def main():
    ...
    opt.vocab_size = len(vocab)#11755
    print(opt)
    # Load data loaders
    ...
    lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(model.optimizer, T_max=20, eta_min=0.0001)
